...
.allin-modal-box{position:relative;z-index:1;width:100%;max-width:444px;max-height:88vh;background:linear-gradient(180deg,#fff 0%,#fafafa 100%);border-radius:20px;padding:24px 22px 28px;box-sizing:border-box;color:#1d1d1f;box-shadow:0 0 0 1px rgba(0,0,0,.05),0 24px 64px rgba(0,0,0,.35);animation:aSU .5s cubic-bezier(.16,1,.3,1);display:flex;flex-direction:column;overflow:hidden}
