...
.allin-modal-video-container{position:relative;width:100%;max-width:380px;margin:0 auto 14px;aspect-ratio:16/9;background:#000;border-radius:10px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,.12);flex-shrink:0}.allin-modal-video-container iframe{position:absolute;top:0;left:0;width:100%;height:100%;border:0}
