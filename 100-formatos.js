...
.allin-swipe-button{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;margin-top:16px;padding:22px 24px;background:linear-gradient(180deg,#fff 0%,#f5f5f7 100%);border:1px solid rgba(0,0,0,.06);color:#1d1d1f;font-size:15px;font-weight:500;letter-spacing:-.015em;text-decoration:none;text-align:center;border-radius:18px;box-shadow:0 1px 2px rgba(0,0,0,.04),0 4px 12px rgba(0,0,0,.06);cursor:pointer;transition:all .5s cubic-bezier(.16,1,.3,1);box-sizing:border-box}
.allin-swipe-button svg{width:16px;height:16px;transition:transform .4s cubic-bezier(.16,1,.3,1)}
.allin-swipe-button:hover{transform:translateY(-2px);box-shadow:0 4px 8px rgba(0,0,0,.06),0 16px 32px rgba(0,0,0,.1)}
.allin-swipe-button:hover svg{transform:translate(2px,-2px)}
...
.allin-modal.allin-modal-active{display:flex;animation:aFI .4s cubic-bezier(.16,1,.3,1)}
...
.allin-modal-box{position:relative;z-index:1;width:100%;max-width:560px;max-height:90vh;background:linear-gradient(180deg,#fff 0%,#fafafa 100%);border-radius:24px;padding:40px;overflow-y:auto;box-sizing:border-box;color:#1d1d1f;box-shadow:0 0 0 1px rgba(0,0,0,.05),0 24px 64px rgba(0,0,0,.35);animation:aSU .5s cubic-bezier(.16,1,.3,1)}
...
.allin-modal-header{display:flex;align-items:center;gap:14px;margin-bottom:16px;margin-top:4px}
...
.allin-modal-title{margin:0;font-size:26px;font-weight:600;color:#1d1d1f;line-height:1.1;letter-spacing:-.025em}
.allin-modal-desc{font-size:15px;line-height:1.55;color:#6e6e73;margin:0 0 28px 0;letter-spacing:-.01em}
.allin-modal-label{font-size:11px;font-weight:600;color:#86868b;margin:0 0 14px 0;text-transform:uppercase;letter-spacing:.08em}
.allin-modal-video-container{position:relative;width:100%;max-width:320px;margin:0 auto 20px;padding-bottom:56%;background:#000;border-radius:14px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,.12)}
.allin-modal-video-container iframe{position:absolute;top:0;left:0;width:100%;height:100%}
.allin-modal-dots{display:flex;justify-content:center;gap:6px;margin-bottom:20px}
...
.allin-tab{background:rgba(0,0,0,.04);border:none;color:#6e6e73;padding:8px 16px;border-radius:999px;font-size:12px;font-weight:500;cursor:pointer;transition:all .3s cubic-bezier(.16,1,.3,1);font-family:inherit}
...
<div class="allin-cover-footer"><div class="allin-cover-name">Frutas de IA</div><div class="allin-cover-cta"><span>Ver formato</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 12h14M13 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round"/></svg></div></div>
</div></div>
...
<div class="allin-card allin-card-cover" onclick="allinOpen(100)">
<div class="allin-cover">
<div class="allin-cover-watermark">101</div>
<div class="allin-cover-header"><div class="allin-cover-badge">101</div><div class="allin-cover-tag">Formato</div></div>
...
<p class="allin-modal-label">Exemplos</p>
...
<div class="allin-modal-tabs"><button class="allin-tab allin-tab-active" onclick="allinSwitch(1)">Exemplo 1</button><button class="allin-tab" onclick="allinSwitch(2)">Exemplo 2</button><button class="allin-tab" onclick="allinSwitch(3)">Exemplo 3</button></div>
  ...
  // JS de comportamento
  var allinFormats=[{"n":"01","t":"Cinema","d":"O vídeo é editado no formato horizontal, remetendo a uma tela de cinema, com bordas arredondadas aplicadas na edição. Pode ter legendas minimalistas, elaboradas ou nenhuma. É possível adicionar camadas visuais que conversam com o que está sendo dito, criando profundidade e enriquecendo a narrativa. Um formato que eleva a percepção de valor e transforma qualquer mensagem em uma experiência visual marcante.","v":["","",""]},{"n":"02","t":"Caixinha de Perguntas","d":"O criador responde a uma pergunta exibida na parte superior do vídeo, simulando a caixinha de perguntas do Instagram. A edição é simples, sem elementos visuais elaborados e no máximo uma legenda do que está sendo respondido. O segredo desse formato está na pergunta: quanto mais polêmica ou provocativa, maior o potencial de engajamento e alcance.","v":["","",""]},{"n":"03","t":"Bate-bola","d":"O criador aparece ao lado de um coadjuvante que apresenta situações rápidas, uma após a outra, enquanto o especialista responde de forma objetiva escolhendo entre duas opções. O formato é extremamente dinâmico e funciona muito bem por despertar curiosidade sobre o que vem a seguir. Quanto mais diretas e sem rodeios forem as respostas, melhor performa.","v":["","",""]},{"n":"04","t":"Central do Atendimento","d":"Uma pessoa liga para o criador pedindo ajuda com uma dor específica. Essa pessoa pode ser um coadjuvante, um amigo ou o próprio criador interpretando um personagem. O criador atende como se fosse um suporte, resolvendo o problema durante a ligação. O formato usa a familiaridade da situação para prender a atenção e entregar valor de forma dinâmica e envolvente.","v":["","",""]},{"n":"05","t":"Reels Dark Clássico","d":"Utiliza um vídeo ou take viral como pano de fundo e coloca uma headline impactante na parte superior. Quanto mais forte e provocativa a headline, melhor o vídeo performa. O formato pode ter tanto um tom de meme quanto inspiracional. Na parte inferior fica o nome do expert, o @ e a foto, como uma espécie de assinatura do conteúdo.","v":["","",""]},{"n":"06","t":"Reels Dark Tela Dividida","d":"Funciona como o reels dark clássico, mas com a tela dividida na horizontal. Na parte superior fica o vídeo ou take viral e na parte inferior uma foto do criador que condiz com o conteúdo. No meio das duas telas fica a headline que conecta os dois elementos. O @ do criador aparece como assinatura. É um formato poderoso para viralizar e ao mesmo tempo fixar a imagem do criador na cabeça de quem assiste.","v":["","",""]},{"n":"07","t":"Corte de Podcast","d":"Um trecho extraído de um podcast onde o criador responde a uma pergunta ou desenvolve um raciocínio de forma aprofundada. Pode aparecer apenas o criador falando ou o entrevistador fazendo a pergunta antes da resposta, o que torna o conteúdo ainda mais dinâmico. É um formato excelente para gerar autoridade pois posiciona o criador como especialista sendo entrevistado, transmitindo credibilidade de forma natural. Funciona muito bem com trechos polêmicos, reveladores ou que gerem identificação imediata.","v":["","",""]},{"n":"08","t":"Entrevista","d":"Uma pessoa faz uma pergunta ao criador, abrindo espaço para uma resposta mais aprofundada e desenvolvida. O entrevistador pode ou não dar uma réplica ao final, comentando ou reagindo à resposta. A câmera foca sempre em quem está falando, o que torna o conteúdo mais dinâmico e mantém a atenção de quem assiste. É um formato que gera autoridade de forma natural, pois coloca o criador no papel de quem é procurado para falar sobre o assunto.","v":["","",""]},{"n":"09","t":"Musical","d":"O criador explica um assunto através de uma música gerada por IA. O ouro do formato está no áudio, a letra precisa ser envolvente e precisa. As imagens que aparecem no vídeo conversam com o que está sendo cantado, criando uma experiência visual e sonora integrada.","v":["","",""]},{"n":"10","t":"Corte de Palestra","d":"Um trecho extraído de uma palestra do criador, editado para destacar um momento de alto impacto e valor. Quanto mais revelador ou transformador o trecho, melhor o resultado. Uma boa música de fundo potencializa o efeito. É um formato excepcional para criadores que palestram, pois gera autoridade de forma imediata e posiciona o criador como referência no seu nicho.","v":["","",""]},{"n":"11","t":"Quadro Branco","d":"O criador dá uma espécie de aula escrevendo em um quadro branco com canetão enquanto explica o conteúdo. Pode olhar diretamente para a câmera como se estivesse explicando para o viewer, ou ignorar completamente a câmera como se estivesse explicando para outra pessoa presente na cena. É um formato que transmite didatismo e autoridade de forma natural, como se o espectador estivesse assistindo a uma aula ao vivo.","v":["","",""]},{"n":"12","t":"Clone","d":"O criador aparece duas vezes na mesma tela, como se tivesse sido clonado. Cada clone representa um lado de uma dualidade, como certo e errado, bom e ruim. Os dois alternam falas durante o vídeo, onde um age de uma forma e o outro age de forma oposta. É um formato que gera identificação imediata por mostrar dois comportamentos contrastantes de forma visual e dinâmica.","v":["","",""]},{"n":"13","t":"Edição PRO","d":"O criador fala, mas a mágica está na edição. Letterings, legendas dinâmicas, b-rolls com takes de filmes, sons estratégicos, recortes e prints na tela e uma trilha sonora envolvente transformam o conteúdo em uma experiência visual de altíssimo nível. É um formato que eleva a percepção de valor e prende a atenção do início ao fim.","v":["","",""]},{"n":"14","t":"Lo-fi Estático","d":"Um formato democrático e acessível. O criador apoia a câmera em algum lugar e fala, sem edição elaborada e sem produção complexa. O que sustenta o vídeo é a força da mensagem. Pode ter legenda ou não, pode conter uma headline de impacto ou não, pode ter música de fundo ou não. Aqui a simplicidade é a estratégia e o poder está no que é dito.","v":["","",""]},{"n":"15","t":"Lo-fi Modo Selfie","d":"O criador liga o modo selfie e fala diretamente para a câmera segurando o celular. Sem edição elaborada, sem produção complexa. O que sustenta o vídeo é a força da mensagem. Pode ter legenda ou não, pode abrir com uma headline de impacto ou ir direto ao ponto, pode ter música de fundo ou não. Transmite proximidade e autenticidade por ser gravado na perspectiva do criador.","v":["","",""]},{"n":"16","t":"Reunião Online","d":"O criador aparece na frente do computador ou tablet como se estivesse em uma reunião online com um mentorado. A câmera capta essa cena de forma natural e o criador entrega uma mensagem de valor como se estivesse orientando alguém na prática. É um formato que gera autoridade de forma sutil, pois mostra o criador no exercício do seu trabalho, sem precisar declarar isso explicitamente.","v":["","",""]},{"n":"17","t":"POV Falado","d":"O criador se coloca em uma cena e fala diretamente para a câmera como se o viewer estivesse vivendo aquele momento junto com ele. O POV é declarado no início do vídeo, geralmente em texto na tela, e o que vem depois é o criador dentro daquela situação. Pode mostrar uma conquista, uma dor, um bastidor ou uma virada. Pode ser também mais descontraído, onde o criador interpreta um personagem relacionado ao seu nicho. Quanto mais o viewer se identificar com o cenário, mais o vídeo performa.","v":["","",""]},{"n":"18","t":"Aula no iPad","d":"O criador explica um conteúdo enquanto desenha ou escreve no iPad em tempo real. A tela é dividida na horizontal com o criador em uma metade e o que está sendo produzido no tablet na outra. A legenda fica no meio, entre as duas telas. É um formato didático e envolvente que prende a atenção por mostrar o raciocínio do criador sendo construído ao vivo.","v":["","",""]},{"n":"19","t":"POV em Texto","d":"O POV é declarado em texto na tela e o que vem depois são takes do criador dentro daquela situação, sem narração. Uma música envolvente carrega o vídeo do início ao fim. Quanto mais cinematográficos e autênticos os takes, mais imersiva a experiência.","v":["","",""]},{"n":"20","t":"Texto na Tela","d":"O conteúdo é entregue inteiramente em texto que vai aparecendo na tela ao longo dos takes do criador, sem nenhuma fala. Uma música de fundo conduz o ritmo do vídeo. O viewer lê enquanto assiste, tornando o consumo rápido e fluido. É um formato excelente para conteúdos reflexivos.","v":["","",""]},{"n":"21","t":"Leia a Legenda","d":"O vídeo abre com um gancho em texto na tela, geralmente uma situação hipotética ou um número chamativo, que direciona o viewer a ler a legenda. Um take de fundo sustenta a atenção enquanto o conteúdo principal está na legenda. O vídeo deve ter menos de 7 segundos, o suficiente para entregar o gancho e empurrar o viewer para a legenda. É um formato que funciona muito bem para listas e conteúdos educativos, pois combina o alcance do vídeo com a profundidade do texto.","v":["","",""]},{"n":"22","t":"Texto Minimalista","d":"Um texto curto e impactante aparece sobre takes cinematográficos de fundo. Sem fala, sem elementos visuais extras. O que sustenta o formato é a qualidade dos takes e uma trilha sonora que esteja em total harmonia com a mensagem. Quando esses três elementos se alinham, o resultado é um conteúdo elegante e marcante.","v":["","",""]},{"n":"23","t":"Tierlist","d":"O criador escolhe um tema central e cria categorias personalizadas para classificar itens relacionados a esse tema. Ao longo do vídeo ele vai encaixando cada item em uma categoria, explicando o raciocínio. É um formato dinâmico, divertido e que gera muito engajamento, pois provoca o viewer a concordar ou discordar das escolhas feitas.","v":["","",""]},{"n":"24","t":"Animação","d":"Animações simples, objetivas e visualmente intuitivas que transmitem uma ideia ou provocam uma reflexão sem precisar de palavras. O poder do formato está na clareza da mensagem visual, o viewer entende a proposta em segundos. Funciona muito bem para comparativos, conceitos e verdades que são mais fáceis de mostrar do que de explicar.","v":["","",""]},{"n":"25","t":"Sim ou Não","d":"Uma voz de fundo apresenta itens relacionados a um tema central e o criador responde sim ou não, justificando rapidamente cada escolha. Imagens dos itens aparecem na tela para dar dinamismo e contextualizar o viewer. É um formato ágil, opinativo e que gera muito engajamento por provocar concordância ou discordância de quem assiste.","v":["","",""]},{"n":"26","t":"Ranking","d":"Define-se um número para o ranking e uma voz de fundo vai apresentando os itens um a um. O criador posiciona cada item sem saber o que vem a seguir, o que torna o formato imprevisível e divertido. A graça está exatamente nisso: o ranking vai sendo montado ao vivo, sem ordem pré-definida, gerando reações genuínas e mantendo o viewer curioso até o fim.","v":["","",""]},{"n":"27","t":"Duelo","d":"Define-se um tema central e a voz de fundo apresenta dois itens que disputam entre si. O criador escolhe um vencedor e esse item permanece na disputa, enfrentando o próximo que a voz de fundo trouxer. Assim vai até acabarem os itens e restar apenas um campeão. É um formato dinâmico e viciante que mantém o viewer engajado até o fim.","v":["","",""]},{"n":"28","t":"Tela Dividida","d":"A tela é dividida na horizontal com o criador falando na parte inferior e imagens que conversam com o conteúdo aparecendo na parte superior. Essas imagens podem ser de filmes, famosos, outros vídeos ou qualquer referência visual que reforce o que está sendo dito. Pode ter uma headline fixa ao centro ou apenas no início para prender a atenção. É um formato que enriquece a narrativa visualmente e mantém o viewer estimulado durante toda a fala.","v":["","",""]},{"n":"29","t":"Dinamismo","d":"O criador usa todos os recursos disponíveis para tornar o vídeo visualmente imprevisível e envolvente. Mudanças de ângulo, troca de cenários, fantasias, objetos que ilustram o que está sendo dito, outros personagens e diferentes estilos de gravação. Tudo acontece de forma rápida e inesperada, criando um conteúdo que prende a atenção do início ao fim. O segredo do formato está na criatividade da execução.","v":["","",""]},{"n":"30","t":"Trivial","d":"O criador faz algo aleatório do dia a dia enquanto fala, descascar uma fruta, tirar o esmalte, dobrar roupas, preparar um café. A ação não tem relação com o conteúdo, ela existe para criar uma sensação de naturalidade e proximidade. É um formato que transmite autenticidade e faz o viewer sentir que está tendo uma conversa informal com o criador.","v":["","",""]},{"n":"31","t":"Narrado","d":"O criador narra em voz off enquanto takes ilustram o que está sendo dito. Pode ser uma experiência que viveu, uma mensagem que quer passar ou até mesmo algo que está fazendo naquele momento. O criador não aparece falando diretamente para a câmera. O conteúdo se sustenta pela força da narrativa e pela qualidade dos takes escolhidos.","v":["","",""]},{"n":"32","t":"The Office","d":"Simula o estilo de falso documentário, onde o criador olha diretamente para a câmera como se estivesse num confessionário comentando uma situação do dia a dia. O tom é irônico, exagerado ou bem-humorado. É um formato que humaniza o criador e cria proximidade com o viewer de forma leve e divertida.","v":["","",""]},{"n":"33","t":"Conversa no Carro","d":"O criador grava dentro do carro e fala diretamente para a câmera. Com o carro parado, a gravação pode ser em selfie. Em movimento o celular pode ficar fixo no suporte ou ser segurado por um copiloto. É um dos formatos mais naturais e descompromissados, o ambiente do carro cria uma sensação de conversa íntima que aproxima o criador do viewer.","v":["","",""]},{"n":"34","t":"Série","d":"O conteúdo é apresentado como um episódio de uma série, com numeração na tela indicando em qual parte o viewer está. É um formato que cria hábito de consumo, fideliza o viewer e constrói um arco narrativo ao longo do tempo.","v":["","",""]},{"n":"35","t":"Bastidores","d":"O criador abre as portas do seu negócio e mostra o que acontece por trás das câmeras. Decisões, situações reais, aprendizados e momentos do dia a dia da operação. É um formato muito poderoso para empresários pois humaniza a marca, gera identificação e constrói autoridade de forma genuína, sem precisar parecer que está tentando impressionar.","v":["","",""]},{"n":"36","t":"Tela Verde","d":"O criador usa o chroma key para aparecer sobre imagens ou vídeos inseridos na edição. Pode ser usado para reagir a um conteúdo que aparece ao fundo ou ilustrar o que está sendo dito com imagens e referências visuais na tela. É um formato extremamente versátil que enriquece visualmente qualquer tipo de conteúdo.","v":["","",""]},{"n":"37","t":"IA Realista","d":"Vídeos gerados por inteligência artificial com aparência realista. O conteúdo é produzido inteiramente por IA, sem necessidade de gravação tradicional. É um formato inovador que chama atenção pela novidade e pelo nível de realismo que a tecnologia já permite entregar.","v":["","",""]},{"n":"38","t":"Tutorial Falado","d":"O criador mostra na prática como fazer algo, começando com um gancho que prende a atenção. O conteúdo é entregue de forma direta e didática, com o criador falando enquanto demonstra o passo a passo. É um formato que gera muito valor e posiciona o criador como referência no que ensina.","v":["","",""]},{"n":"39","t":"Corte YouTube","d":"Um trecho extraído de um vídeo longo do YouTube do criador. Aproveita-se um momento de alto valor ou impacto para distribuir no formato curto. Pode ter uma headline para potencializar o desempenho. É uma forma inteligente de reaproveitar conteúdo já produzido e ampliar o alcance do que foi dito.","v":["","",""]},{"n":"40","t":"Troque Isso por Isso","d":"O criador apresenta trocas que devem ser feitas, usando as mãos para dar dinamismo à fala. Na edição aparecem elementos visuais que reforçam o que está sendo dito. É um formato direto e de fácil consumo que gera identificação imediata por mostrar comportamentos ou hábitos que o viewer pode substituir na prática.","v":["","",""]},{"n":"41","t":"RayBan Meta","d":"O criador grava usando os óculos RayBan Meta, que captam tudo pela perspectiva do seu próprio olhar. O viewer vive a experiência como se fosse o próprio criador, vendo a rotina, momentos do dia, interações e situações do jeito que o criador vê. É um formato que gera imersão e proximidade de forma muito natural e autêntica.","v":["","",""]},{"n":"42","t":"Interações na Rua","d":"O criador vai até pessoas na rua e propõe situações, desafios ou pedidos inusitados enquanto uma câmera acompanha tudo. As reações genuínas das pessoas são o coração do formato. Ver pessoas reais em situações inesperadas é o que torna o conteúdo altamente assistível e compartilhável.","v":["","",""]},{"n":"43","t":"Entrevistas na Rua","d":"O criador aborda pessoas na rua e faz perguntas sobre um tema central. Pode entrevistar uma única pessoa ou várias ao longo do mesmo vídeo. As respostas reais e espontâneas são o que torna o formato envolvente.","v":["","",""]},{"n":"44","t":"Palestrinha","d":"O criador apresenta um conteúdo usando slides exibidos no computador ou na TV, simulando uma palestra. O formato combina a autoridade de uma apresentação estruturada com a informalidade de um vídeo curto. É dinâmico, didático e funciona muito bem para listas, conceitos e conteúdos que se beneficiam de apoio visual.","v":["","",""]},{"n":"45","t":"Áudio Viral Motivacional","d":"O criador aparece em um take enquanto um áudio motivacional viral toca de fundo. A força do formato está na combinação entre a imagem do criador e uma fala ou mensagem. Quando o áudio ressoa com o posicionamento do criador, o conteúdo ganha autoridade e identificação de forma imediata.","v":["","",""]},{"n":"46","t":"Corte de Podcast Cinema","d":"Um corte de podcast editado com bordas arredondadas, legendas dinâmicas com fontes variadas e efeitos visuais que elevam a produção. É a combinação da autoridade do formato podcast com a estética cinematográfica, tornando o conteúdo mais impactante e visualmente marcante.","v":["","",""]},{"n":"47","t":"Filtros de Ranking","d":"O criador usa filtros de ranking disponíveis dentro do próprio TikTok para classificar itens em tempo real, sem saber qual vem a seguir. Os filtros precisam ser pesquisados na plataforma, pois existem milhares de opções. É um formato nativo do TikTok, dinâmico e divertido.","v":["","",""]},{"n":"48","t":"Tutorial em Texto","d":"O criador ensina como fazer algo sem precisar falar. As instruções aparecem escritas na tela ao longo dos takes de apoio que ilustram o passo a passo. É um formato acessível e de fácil consumo, ideal para quem prefere ensinar sem aparecer falando diretamente para a câmera.","v":["","",""]},{"n":"49","t":"Unboxing","d":"O criador abre um produto na câmera e o apresenta. Pode falar sobre ele ou deixar a experiência visual falar por si. É um formato que gera curiosidade e proximidade, pois o viewer acompanha o momento junto com o criador.","v":["","",""]},{"n":"50","t":"Trechos de Filmes","d":"Cenas marcantes de filmes que carregam uma reflexão poderosa. O trecho escolhido fala por si, sem necessidade de muita edição. O segredo está na curadoria, quanto mais a cena ressoar com o público, maior o impacto e o alcance do conteúdo.","v":["","",""]},{"n":"51","t":"Papel e Caneta","d":"O criador explica um assunto escrevendo em papel com caneta em tempo real. Pode aparecer no vídeo ou mostrar apenas as mãos e o papel. É um formato simples e didático que transmite clareza e proximidade, como se o criador estivesse explicando algo pessoalmente para o viewer.","v":["","",""]},{"n":"52","t":"Tela Dividida Vertical","d":"Uma headline impactante aparece na parte superior do vídeo. Abaixo, a tela é dividida na vertical com o criador falando do lado esquerdo e uma imagem que remete ao assunto do lado direito. Na parte inferior fica o @ do criador como assinatura. A imagem de apoio reforça visualmente a mensagem e torna o conteúdo mais dinâmico e chamativo.","v":["","",""]},{"n":"53","t":"Comparativo em Texto","d":"Dois elementos são comparados lado a lado com textos na tela. Sem necessidade de fala, o conteúdo se sustenta pelos textos e pela força do comparativo.","v":["","",""]},{"n":"54","t":"Trabalho na Prática","d":"O criador grava a si mesmo exercendo seu trabalho no dia a dia, seja atendendo um cliente, realizando um procedimento ou executando qualquer atividade da sua área. É um formato que gera autoridade de forma genuína, pois mostra o criador em ação sem precisar declarar sua competência.","v":["","",""]},{"n":"55","t":"Esquete","d":"Uma cena curta e bem humorada que exagera a dor ou o problema do público. O criador interpreta personagens dentro de uma situação cômica relacionada ao seu nicho. O humor é o que prende a atenção e cria identificação, tornando a mensagem muito mais fácil de consumir e compartilhar.","v":["","",""]},{"n":"56","t":"Rotina","d":"O criador mostra o seu dia do início ao fim, com takes do que acontece ao longo das horas. É um formato que gera proximidade e identificação, pois o viewer acompanha a vida real do criador e se conecta com ela de forma natural.","v":["","",""]},{"n":"57","t":"A, B, C, D e E","d":"Uma voz de fundo vai apresentando itens relacionados a um tema e o criador classifica cada um em categorias de A até E, sendo A o melhor e E o pior. É um formato opinativo e dinâmico que gera muito engajamento pois provoca o viewer a concordar ou discordar das classificações feitas.","v":["","",""]},{"n":"58","t":"Vlog","d":"O criador registra um momento, seja uma viagem, um passeio ou um dia de trabalho, com takes do que acontece ao longo da experiência. Normalmente é narrado em voz off, mas pode ter falas naturais captadas durante a gravação. É um formato que gera muita proximidade pois o viewer acompanha o criador de forma imersiva e autêntica.","v":["","",""]},{"n":"59","t":"Certo x Errado","d":"Mostra-se através de takes o que é certo e o que é errado sobre determinado tema. O conteúdo é entregue apenas em texto na tela, sem necessidade de fala. É um formato direto e de fácil consumo.","v":["","",""]},{"n":"60","t":"Frutas de IA","d":"Uma animação de frutas gerada por inteligência artificial conta uma história sobre qualquer assunto. O formato chama atenção pelo inusitado e pela criatividade.","v":["","",""]},{"n":"61","t":"Tela Dividida com Imagem","d":"A tela é dividida na horizontal com o criador falando na parte superior e uma imagem que remete ao assunto na parte inferior. A legenda fica centralizada entre as duas telas. É um formato que enriquece visualmente o conteúdo e reforça a mensagem do criador com uma referência visual direta ao tema.","v":["","",""]},{"n":"62","t":"Animação Explicativa","d":"Animações que ilustram conceitos enquanto a narração ou texto guia o viewer. O formato funciona muito bem para temas que precisam de apoio visual para serem compreendidos com clareza.","v":["","",""]},{"n":"63","t":"Faz e Escreve","d":"O criador realiza uma ação enquanto escreve mensagens ou explicações na tela. A combinação entre o que está sendo feito e o que está sendo escrito cria uma camada extra de comunicação e dinamismo.","v":["","",""]},{"n":"64","t":"Chroma Key","d":"O criador grava com um fundo verde e na edição insere imagens, vídeos ou cenários no lugar do fundo. É um formato versátil que permite colocar qualquer elemento visual atrás do criador, enriquecendo o conteúdo sem precisar de produção elaborada no momento da gravação.","v":["","",""]},{"n":"65","t":"Autoridade Roubada","d":"O criador insere uma foto ou vídeo de uma pessoa famosa no conteúdo, seja de forma aleatória ou simulando que o famoso reagiu ao que está sendo dito. O viewer reconhece o famoso e isso transfere credibilidade para o criador de forma indireta. É um formato especialmente poderoso para contas menores que ainda estão construindo autoridade no nicho.","v":["","",""]},{"n":"66","t":"React Clássico","d":"A tela é dividida na horizontal com o vídeo original na parte superior e o criador reagindo na parte inferior. Pode ter uma headline no meio ou não. Ao final do vídeo, o criador comenta o que viu e entrega sua perspectiva sobre o assunto. É um formato que gera engajamento pois o viewer acompanha a reação em tempo real e fica curioso para saber o que o criador vai falar no final.","v":["","",""]},{"n":"67","t":"Diálogo de Gêmeos","d":"O criador interpreta dois personagens sozinho, podendo usar roupas ou acessórios diferentes para diferenciar cada um. Os dois travam um diálogo como se fosse uma conversa real, o que torna o formato dinâmico e divertido. É muito bom para responder dúvidas, apresentar pontos de vista opostos ou explicar conceitos de forma leve e envolvente.","v":["","",""]},{"n":"68","t":"Take + Vídeo Viral","d":"O criador aparece em um take com uma chamada escrita na tela, sem falar nada, que direciona o viewer para o que vem a seguir. Em seguida corta para um vídeo viral de outro criador, um trecho de filme, podcast ou palestra que entrega a reflexão ou mensagem prometida. É um formato que usa a curiosidade como gatilho e aproveita o alcance de conteúdos já validados para engajar o viewer.","v":["","",""]},{"n":"69","t":"Reunião Presencial","d":"O criador aparece em uma reunião presencial, num escritório ou sala de reunião, falando ou passando uma visão. É um formato que transmite autoridade e profissionalismo de forma natural, pois mostra o criador no ambiente de trabalho sem precisar declarar sua relevância.","v":["","",""]},{"n":"70","t":"Análise","d":"O criador analisa algo do seu nicho em profundidade, demonstrando domínio completo sobre o assunto. É um formato que posiciona o criador como autoridade de forma genuína, pois o viewer percebe o nível de conhecimento pela qualidade da análise.","v":["","",""]},{"n":"71","t":"Analogia","d":"O criador explica um conceito do seu nicho através de comparações com situações ou objetos do cotidiano, sem abordar o assunto de forma direta. A analogia facilita o entendimento e torna a mensagem mais fácil de absorver e lembrar. Quanto mais criativa e inesperada a comparação, mais o formato tende a engajar.","v":["","",""]},{"n":"72","t":"Infográfico","d":"Um elemento visual que ilustra uma ideia ou conceito aparece sobre um take do criador ao fundo, com uma música que combina com a proposta. O infográfico organiza a informação de forma visual e intuitiva, tornando mensagens complexas fáceis de entender em poucos segundos.","v":["","",""]},{"n":"73","t":"Estático em Vídeo","d":"Uma imagem estática é publicada como vídeo com um efeito de fade no início. Uma headline acompanha a imagem. É um formato simples e rápido de produzir que funciona bem para frases de impacto, reflexões e conteúdos que não precisam de movimento para transmitir a mensagem.","v":["","",""]},{"n":"74","t":"ASMR","d":"O criador mostra seu trabalho no dia a dia capturando os sons do ambiente de forma intencional. Sem narração, o conteúdo se sustenta pelos sons e pelas imagens do processo. É um formato relaxante e hipnótico que prende a atenção de forma sutil.","v":["","",""]},{"n":"75","t":"Revelação no Papel","d":"O criador segura uma folha com perguntas ou tópicos e vai revelando as respostas uma a uma, removendo algo que as cobria. O suspense de cada revelação é o que prende a atenção e mantém o viewer assistindo até o fim. É um formato simples de produzir.","v":["","",""]},{"n":"76","t":"Para Isso, Indico Isso","d":"Uma voz de fundo apresenta uma situação ou necessidade e o criador responde com uma indicação direta e objetiva. É um formato ágil e dinâmico que posiciona o criador como referência no seu nicho, pois demonstra repertório e autoridade a cada resposta.","v":["","",""]},{"n":"77","t":"Analogia em Texto","d":"O criador aparece de fundo com expressões e objetos que compõem a cena enquanto textos na tela entregam a mensagem através de uma analogia. Sem narração, o conteúdo se sustenta pela combinação entre a expressão do criador, os elementos visuais e o texto. É um formato elegante e criativo que facilita o entendimento de conceitos complexos de forma visual e intuitiva.","v":["","",""]},{"n":"78","t":"Significado nos Comentários","d":"O criador apresenta uma escolha na tela pedindo para o viewer selecionar uma opção sem entender muito bem o que cada uma significa. A explicação e o significado de cada escolha estão na legenda do post. É um formato que gera retenção, pois as pessoas ficam lendo a legenda para entender o resultado da sua escolha, e tende a gerar muitos comentários pois o viewer quer compartilhar o que escolheu.","v":["","",""]},{"n":"79","t":"3 Coisas, 3 Categorias","d":"O criador apresenta três itens classificados em três categorias definidas por ele. Enquanto fala, usa gestos e aponta para cada item que aparece na edição ao lado dele. É um formato direto e opinativo que gera muito engajamento pois provoca o viewer a concordar ou discordar das escolhas feitas.","v":["","",""]},{"n":"80","t":"Bom e Ruim","d":"Uma voz de fundo apresenta dois itens da mesma categoria e o criador explica o motivo de um ser bom e o outro ruim. Na edição aparecem os itens na tela para ilustrar o que está sendo dito. É um formato direto e opinativo que gera identificação e debate, pois o viewer muitas vezes usa ou conhece os itens apresentados.","v":["","",""]},{"n":"81","t":"Falado em Público","d":"O criador fala sobre seu assunto enquanto está em um ambiente público, como um shopping ou uma praça, completamente alheio ao movimento ao redor. As outras pessoas se tornam figurantes da cena. Uma pessoa grava enquanto ele anda e fala. É um formato que transmite naturalidade e confiança, pois mostra o criador totalmente à vontade independente do ambiente.","v":["","",""]},{"n":"82","t":"Comparativo Falado","d":"O criador fala sobre dois lados de um mesmo tema enquanto imagens aparecem na tela para ilustrar o que está sendo dito. É um formato dinâmico e provocativo que gera muita identificação e debate, pois coloca o viewer para refletir sobre qual lado se encaixa na sua realidade.","v":["","",""]},{"n":"83","t":"Gêmea Boa e Ruim","d":"A tela é dividida na vertical com o criador interpretando dois personagens ao mesmo tempo, um representando o comportamento certo e o outro o errado. É um formato que mostra dualidade de forma visual e direta, pois o viewer consegue comparar os dois lados na mesma tela.","v":["","",""]},{"n":"84","t":"Não Faça Isso, Faça Isso","d":"O criador propõe substituições diretas, apresentando o comportamento ou atitude errada e a versão correta no lugar. As trocas aparecem na edição de forma visual e organizada enquanto o criador fala. É um formato prático e de alto valor que gera identificação imediata pois o viewer reconhece os comportamentos que precisa mudar.","v":["","",""]},{"n":"85","t":"Diálogo com Famoso","d":"O criador interage com a imagem ou vídeo de um famoso na edição, simulando um diálogo. O formato combina humor, identificação e o reconhecimento do famoso para criar conteúdos memoráveis e altamente compartilháveis.","v":["","",""]},{"n":"86","t":"Fundo Narrativo em Destaque","d":"O criador aparece pequeno e centralizado na tela enquanto imagens e vídeos de fundo dominam o espaço visual. A legenda acompanha o que está sendo dito. O foco não é o rosto do criador mas sim as imagens que ilustram e dão dinamismo à mensagem.","v":["","",""]},{"n":"87","t":"Trigêmeos","d":"O criador aparece três vezes na mesma tela interpretando três versões diferentes de si mesmo. Cada uma traz uma perspectiva ou comportamento distinto, criando um diálogo entre os três. É um formato divertido e visualmente rico que multiplica a presença do criador na cena.","v":["","",""]},{"n":"88","t":"Se Você Quer Isso, Faça Isso","d":"O criador apresenta uma lógica direta de causa e consequência: se você faz ou quer determinada coisa, o caminho é esse. Mapas mentais e infográficos aparecem na parte superior para apoiar visualmente a explicação. É um formato prático e objetivo que entrega valor de forma clara e direta.","v":["","",""]},{"n":"89","t":"Bastidores dos Conteúdos","d":"O criador mostra como produz seus conteúdos por trás das câmeras. Uma câmera registra o processo de gravação, os equipamentos, a preparação e tudo que acontece antes do resultado final aparecer na tela. É um formato que gera curiosidade e proximidade, pois o viewer tem acesso a algo que normalmente não vê.","v":["","",""]},{"n":"90","t":"Antes e Depois Lo-fi","d":"O criador mostra o antes e o depois de uma transformação do seu trabalho de forma simples e direta, com um áudio de fundo. As transições entre os dois momentos podem ser criativas e dinâmicas para quebrar o padrão. É um formato muito poderoso para nichos onde a transformação visual é o produto, pois o resultado fala por si.","v":["","",""]},{"n":"91","t":"Narrado com IA","d":"O vídeo é gerado e narrado inteiramente por inteligência artificial. As imagens e animações explicativas de fundo são criadas por IA e a narração também. É um formato que permite criar conteúdos visualmente impressionantes e didáticos sobre qualquer assunto sem precisar aparecer ou falar.","v":["","",""]},{"n":"92","t":"React na TV","d":"O criador assiste a um vídeo em uma TV real enquanto é gravado. Ao final, pausa o vídeo e faz seu comentário sobre o que assistiu. É uma versão mais imersiva e cinematográfica do react convencional, pois o ambiente e a TV real criam uma cena mais natural e envolvente.","v":["","",""]},{"n":"93","t":"Antes e Depois em Texto","d":"O criador aponta para os elementos que aparecem na edição sem precisar falar. O antes e o depois são apresentados visualmente na tela enquanto o criador apenas gesticula. É um formato clean e eficiente que entrega o comparativo de forma rápida e direta.","v":["","",""]},{"n":"94","t":"Pergunta e Responde","d":"O criador é filmado fazendo algo do cotidiano quando o cameraman chega e faz uma pergunta sobre o nicho. O criador responde de forma natural. É um formato que transmite muita autenticidade e proximidade pois captura o criador em um momento real e descontraído.","v":["","",""]},{"n":"95","t":"Conversa de Bar","d":"A câmera é posicionada como se fosse mais uma pessoa na roda. O criador troca ideia com alguém ou fala como se estivesse em uma conversa em grupo, sem olhar diretamente para a câmera. O viewer tem a sensação de estar presente na conversa, como se fosse um integrante da roda. É um formato que gera proximidade e autenticidade de forma muito natural.","v":["","",""]},{"n":"96","t":"Narrador","d":"Uma voz de narrador gerada por IA conta uma história sobre o criador enquanto takes ilustram o que está sendo narrado. O criador interage com o narrador como se ele fosse uma pessoa real, reagindo, concordando ou discordando do que está sendo dito. É um formato criativo e divertido que cria uma dinâmica inusitada e prende a atenção pela imprevisibilidade.","v":["","",""]},{"n":"97","t":"Telepatia","d":"O criador se grava em silêncio, usando apenas expressões e linguagem corporal, e adiciona uma narração por cima como se fosse o pensamento interno dele acontecendo em tempo real. O viewer acompanha o raciocínio e os sentimentos do criador de forma íntima e divertida. É um formato que gera muita identificação pois simula algo que todos vivem mas raramente compartilham.","v":["1V7wjiE3CVfhAXoEjmZFIZElHF_ToKVNR","",""]},{"n":"98","t":"UGC em Primeira Pessoa","d":"O criador não aparece no vídeo. A câmera fica na perspectiva do seu olhar enquanto apresenta um item, como se o viewer estivesse segurando o produto nas próprias mãos. O tom é natural e informal, como uma recomendação sincera de alguém que realmente usou. É um formato que gera muita confiança pela autenticidade.","v":["","",""]},{"n":"99","t":"UGC em Terceira Pessoa","d":"O criador se filma com o celular falando diretamente para a câmera, como se estivesse dando uma dica sincera para um amigo. O tom é informal e autêntico, sem produção elaborada. Parece uma recomendação genuína de quem realmente usou ou viveu aquilo que está sendo dito.","v":["","",""]},{"n":"100","t":"Google Meet","d":"O criador se grava no Google Meet enquanto explica um assunto. Na parte superior aparecem imagens e takes que ilustram o que está sendo dito. Pode ter uma headline ou não. É um formato que transmite autoridade, proximidade e seriedade pelo ambiente de reunião, como se o criador estivesse apresentando algo importante para o viewer.","v":["","",""]},{"n":"101","t":"Lista","d":"O criador apresenta uma lista sobre um tema central enquanto os itens vão aparecendo na edição conforme ele fala. É um formato simples, direto e de alto valor que funciona muito bem para conteúdos educativos.","v":["","",""]}];
var allinCV=['','',''];
function allinOpen(i){var f=allinFormats[i];if(!f)return;document.getElementById('aMB').textContent=f.n;document.getElementById('aMT').textContent=f.t;document.getElementById('aMD').textContent=f.d;allinCV=f.v;var ts=document.querySelectorAll('.allin-tab'),ds=document.querySelectorAll('.allin-dot');for(var j=0;j<ts.length;j++){if(allinCV[j]){ts[j].disabled=false;ds[j].style.display=''}else{ts[j].disabled=true;ds[j].style.display='none'}}if(allinCV[0]){allinSwitch(1)}else{document.getElementById('aMI').src=''}document.getElementById('allinModal').classList.add('allin-modal-active');document.body.style.overflow='hidden'}
function allinSwitch(n){var v=allinCV[n-1];if(!v)return;document.getElementById('aMI').src='https://drive.google.com/file/d/'+v+'/preview';var ts=document.querySelectorAll('.allin-tab'),ds=document.querySelectorAll('.allin-dot');for(var j=0;j<ts.length;j++){ts[j].classList.remove('allin-tab-active');ds[j].classList.remove('allin-dot-active')}ts[n-1].classList.add('allin-tab-active');ds[n-1].classList.add('allin-dot-active')}
function allinClose(){document.getElementById('allinModal').classList.remove('allin-modal-active');document.getElementById('aMI').src='';document.body.style.overflow=''}
