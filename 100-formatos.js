...
.allin-modal-desc{font-size:14px;line-height:1.55;color:#6e6e73;margin:0 0 20px 0;letter-spacing:-.01em}
...
.allin-modal-video-container{position:relative;width:100%;max-width:220px;margin:0 auto 16px;aspect-ratio:9/16;background:#000;border-radius:12px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,.12)}.allin-modal-video-container iframe{position:absolute;top:0;left:0;width:100%;height:100%;border:0}
...
<div class="allin-modal-video-container"><iframe id="aMI" src="" frameborder="0" allow="autoplay; encrypted-media; fullscreen; picture-in-picture" allowfullscreen></iframe></div>
